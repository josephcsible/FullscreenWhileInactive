...
@MCVersion("1.7.10")
public class FullscreenWhileInactiveLoadingPlugin implements IFMLLoadingPlugin {
	...
	public String[] getASMTransformerClass() {
		return new String[]{FullscreenWhileInactiveClassTransformer.class.getName()};
	}

	@Override
	public String getModContainerClass() {
		return FullscreenWhileInactiveModContainer.class.getName();
	}
